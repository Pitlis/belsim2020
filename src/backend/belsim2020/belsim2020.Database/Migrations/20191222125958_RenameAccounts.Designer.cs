...
namespace belsim2020.Database.Migrations
{
    ...
    [Migration("20191222125958_RenameAccounts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("belsim2020.Entities.RkAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RkAccountId = new Guid("eaacc9f3-a658-4218-ac77-3aefcf278c3d"),
                            Name = "_Счёт 10: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f62"),
                            Name = "_Счёт 18: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f63"),
                            Name = "_Счёт 20: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f64"),
                            Name = "_Счёт 40: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f65"),
                            Name = "_Счёт 43: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f66"),
                            Name = "_Счёт 50: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f67"),
                            Name = "_Счёт 51: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f68"),
                            Name = "_Счёт 60: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f69"),
                            Name = "_Счёт 62: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f10"),
                            Name = "_Счёт 68: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f11"),
                            Name = "_Счёт 69: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f12"),
                            Name = "_Счёт 70: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f13"),
                            Name = "_Счёт 76: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f14"),
                            Name = "_Счёт 81: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f15"),
                            Name = "_Счёт 83: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f16"),
                            Name = "_Счёт 84: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f17"),
                            Name = "_Счёт 90: Начальное значение(отн.ед.)"
                        },
                        new
                        {
                            RkAccountId = new Guid("d6d2e616-39b5-4b16-8fdb-15e28d050f18"),
                            Name = "_Счёт 99: Начальное значение(отн.ед.)"
                        });
                });
            ...
            modelBuilder.Entity("belsim2020.Entities.RkExperiment", b =>
                {
                    b.Property<Guid>("RkExperimentId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("ExperimentData");
                    ...
                    b.HasKey("RkExperimentId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("ExperimentTemplateId");

                    b.ToTable("RK_Experiments");
                });
            ...
            modelBuilder.Entity("belsim2020.Entities.RkExperiment", b =>
                {
                    b.HasOne("belsim2020.Entities.User", "CreatedBy")
                        .WithMany()
